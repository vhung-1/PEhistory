"""
splice_819.py — Add 2026-08-19 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = git HEAD:data.json (8/18),
new axis = current data.json (8/24). One new trading day. F=median(base/pull) over the
Jan–Aug overlap, applied to 8/24, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787639311567.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787639319108.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787639326630.txt',
]
NEW_DATES = {'2026-08-24'}
