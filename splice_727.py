...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785220466403.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785220474469.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785220483203.txt',
]
NEW_DATES = {'2026-07-27'}
