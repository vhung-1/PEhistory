"""
splice_925.py — Add 2026-09-24 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/23),
new axis = current data.json (9/24). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/24, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790316711801.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790316718931.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790316727053.txt',
]
NEW_DATES = {'2026-09-24'}
...
print('\nComputing scale factors and splicing 9/24...')
flags = []; full = {}
