"""
splice_917.py — Add 2026-09-16 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/15),
new axis = current data.json (9/16). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/16, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789642316950.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789642322550.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789642328175.txt',
]
NEW_DATES = {'2026-09-16'}
...
print('\nComputing scale factors and splicing 9/16...')
flags = []; full = {}
