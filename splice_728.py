...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785306410334.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785306416918.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785306423023.txt',
]
NEW_DATES = {'2026-07-28'}
