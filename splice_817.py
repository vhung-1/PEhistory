...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787033803036.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787033811011.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787033818276.txt',
]
NEW_DATES = {'2026-08-17'}
