"""
splice_821.py — Add 2026-08-19 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = git HEAD:data.json (8/18),
new axis = current data.json (8/21). Fills TWO days: 8/20 (left null last round when the
S&P connector was down) and 8/21 (the new close). F=median(base/pull) over the Jan–Aug
overlap, applied to both, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787554674090.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787554683037.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787554690779.txt',
]
NEW_DATES = {'2026-08-20','2026-08-21'}
