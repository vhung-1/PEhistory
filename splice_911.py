"""
splice_911.py — Add 2026-09-09 daily closes to daily_px.json via the scale-factor
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789021466695.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789021469188.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789021472039.txt',
]
