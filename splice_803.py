...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785826859176.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785826866939.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785826873710.txt',
]
NEW_DATES = {'2026-08-03'}
