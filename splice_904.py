"""
splice_904.py — Add 2026-09-04 daily closes to daily_px.json via the scale-factor
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788725100281.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788725100127.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788725100195.txt',
]
NEW_DATES = {'2026-09-04'}
