...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787206059982.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787206068081.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787206075212.txt',
]
NEW_DATES = {'2026-08-19'}
