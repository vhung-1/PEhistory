...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786803989748.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786803997446.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786804004017.txt',
]
NEW_DATES = {'2026-08-14'}
