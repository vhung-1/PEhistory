"""
splice_924.py — Add 2026-09-23 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/22),
new axis = current data.json (9/23). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/23, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790230620994.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790230626942.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790230632801.txt',
]
...
print('\nComputing scale factors and splicing 9/23...')
flags = []; full = {}
