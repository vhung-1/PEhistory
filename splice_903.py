...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788536033582.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788536041232.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1788536048169.txt',
]
NEW_DATES = {'2026-09-03'}
