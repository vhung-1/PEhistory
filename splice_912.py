"""
splice_912.py — Add 2026-09-10 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/9),
new axis = current data.json (9/10). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/10, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789110950904.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789110958293.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789110959699.txt',
]
NEW_DATES = {'2026-09-10'}
...
print('\nComputing scale factors and splicing 9/10...')
flags = []; full = {}
