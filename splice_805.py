...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785997384930.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785997392049.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1785997398340.txt',
]
NEW_DATES = {'2026-08-05'}
