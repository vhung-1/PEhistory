"""
splice_923.py — Add 2026-09-22 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/21),
new axis = current data.json (9/22). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/22, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790144774098.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790144779972.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1790144785801.txt',
]
NEW_DATES = {'2026-09-22'}
...
print('\nComputing scale factors and splicing 9/22...')
flags = []; full = {}
