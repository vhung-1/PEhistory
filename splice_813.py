...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786690613264.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786690621372.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1786690628367.txt',
]
NEW_DATES = {'2026-08-13'}
