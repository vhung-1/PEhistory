"""
splice_916.py — Add 2026-09-15 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/14),
new axis = current data.json (9/15). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/15, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789557534031.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789557559003.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789557583209.txt',
]
NEW_DATES = {'2026-09-15'}
...
print('\nComputing scale factors and splicing 9/15...')
flags = []; full = {}
