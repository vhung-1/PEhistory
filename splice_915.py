"""
splice_915.py — Add 2026-09-14 daily closes to daily_px.json via the scale-factor
splice (CLAUDE.md §7c). One new trading day. old axis = /tmp/data_prev.json (9/11),
new axis = current data.json (9/14). Reads the 3 S&P pull files, computes
F=median(base/pull) over the Jan–Sep overlap, applies F to 9/14, realigns.
"""
...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789469830585.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789469853263.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1789469875881.txt',
]
NEW_DATES = {'2026-09-14'}
...
print('\nComputing scale factors and splicing 9/14...')
flags = []; full = {}
