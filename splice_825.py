...
PULL_FILES = [
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787738632421.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787738640829.txt',
    TR + '/mcp-S_P_Global-get_prices_from_identifiers-1787738648749.txt',
]
NEW_DATES = {'2026-08-25'}
